...
class MySqlConnection extends PDO implements DatabaseConnectionInterface
{
    ...
    //TODO: расставить метод по местам где будет логироваться запрос, инжектить $eventDispatcher через конструктор
    private function triggerLogEvent(PDOStatement $stmt): PDOStatement
    {
